...
def create_attrs(topK, keepTopK):
    ...
    attrs["scoreThreshold"] = 0.30 #0.70
...
def main():
    ...
    parser.add_argument("-f", "--model", help="Path to the ONNX model generated by export_model.py", default="D:\\AI\\YOLO\\yolov8-main\\runs\\detect\\train3\\weights\\best_1.onnx")
